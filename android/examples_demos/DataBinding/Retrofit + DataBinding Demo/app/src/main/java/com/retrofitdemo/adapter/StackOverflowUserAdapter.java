...
import com.retrofitdemo.app.databinding.ListRowResultBinding;
...
//                .into(holder.personPhoto);
    ...
    public class RecyclerViewHolders extends RecyclerView.ViewHolder  {
        ...
        public void bind(StackOverflowUser.Item user) {
            binding.setUser(user);
            binding.setHandler(new ClickHandler(user));
        }
